...
const LOOP_12: i32 = 0x40000000;
const LOOP_21: i32 = 1000;
const LOOP_22: i32 = 0x40000000;
...
fn block1(iv: [u32; 4], mut ct1: i32, s: &mut StateS) -> i32
{
    ...
    'block1_again: loop
    {
        ...
        'loop_12: loop
        {
            ...
            /* possible cause */
            //println!("s.q0[61] {:?} a0 {:?} s.q1[61] {:?} a1 {:?}", s.q0[61], s.a0, s.q1[61], s.a1);
            if (s.a0 ^ s.a1) != 0x80000000
                { cnt += 1; continue 'loop_12; }
...
fn main() -> std::io::Result<()>
{
    ...
    let items: Vec<_> = iter::repeat(0).take(2).collect();
